 ...
 *
 * <p>Implementing classes MUST override {@link Object#equals(Object)} to enable calling {@code
 * vmObjectLike.equals()} when not behind a Truffle boundary.
 */
public interface VmObjectLike extends VmValue {

  // --- Enclosing frame and extra storage ---

  /** Returns the frame that was active when this object was instantiated. */
